...
| [contour-drawing](https://github.com/TLausZ/contour-drawing) — my own tool, turns a photo into contour lines and writes plotter ready SVG, forked from [krummrey](https://github.com/krummrey/contour-drawing) | <img src="https://raw.githubusercontent.com/TLausZ/contour-drawing/main/example/warhol.svg" width="400" alt="Andy Warhol portrait as a contour drawing"> |
| [DrawingBotV3](https://drawingbotv3.com/) — turns photos into line drawings with dozens of pen and hatching styles, my favourite of the paid tools. Its author teaches it on [YouTube](https://www.youtube.com/@drawingbotv3): start with the [beginner series](https://www.youtube.com/playlist?list=PLDPNDW2dqMA0sAHhvuDRd27tcy28PWU8Z), then the [feature spotlights](https://www.youtube.com/playlist?list=PLDPNDW2dqMA2AiuVd0tzcL3Fd5FdHKqNj) | <img src="images/drawingbot.webp" width="400" alt="Dancer in a swirling dress drawn in coloured pen strokes"> |
...
| [Tissage Studio](https://tissagestudio.etienne.design/) — turns an image into diagonal line bands of varying weight, browser based with a sample gallery | <img src="images/tissage-studio.webp" width="400" alt="Duckling photo next to its line band rendering"> |
...
| [Krbn](https://github.com/vpalos/Krbn) — renders 3D scenes as pencil strokes, hidden lines and hatching solved analytically | <img src="https://raw.githubusercontent.com/vpalos/Krbn/main/examples/gallery/16-gravity-well.svg" width="400" alt="A sphere resting in a gravity well, drawn in hatching"> |
...
| [Blender Freestyle SVG export](https://docs.blender.org/manual/en/3.6/addons/render/render_freestyle_svg.html) — the Freestyle SVG Exporter add-on writes Blender's non-photorealistic line rendering straight to SVG, contour lines and hidden line removal for any 3D scene, bundled with Blender up to 4.1 | <img src="images/blender-freestyle.webp" width="400" alt="Two Stanford bunnies sliced into horizontal contour lines"> |
| [Streamline Loops](https://msurguy.github.io/streamline-loops/?preset=Cosine%20Weave&tr=0.004&lw=0.004&lc=%2331d4e2&bg=%239effb6&cm=blender%20path&pj=orthographic&os=3&ls=30) — Maksim Surguy's browser tool that traces streamlines through formula-defined 3D vector fields and renders them as looping orbit animations, the flat meshline mode looks like a plot, exports MP4 or PNG frames but no SVG | <img src="images/streamline-loops.webp" width="400" alt="Sphere of wavy teal streamlines rotating on a mint background"> |
| [generative-noodles](https://github.com/cadin/generative-noodles) — Processing sketch that grows tangled noodle shapes and saves them as plotter ready SVG | <img src="https://raw.githubusercontent.com/cadin/generative-noodles/main/banner.png" width="400" alt="Tangled noodle shapes drawn with a plotter"> |
...
| [Truchet Mosaic Generator](https://swazara.github.io/truchet-web-generator/) — Truchet tiles in the browser with swappable tile sets, exports SVG | <img src="images/truchet.webp" width="400" alt="Truchet tile pattern of interlocking curves"> |
| [Book of Shapes](https://www.bookofshapes.com/) — Nikolaj Sokolowski's collection of minimal generative patterns, each one tweakable in the browser and exported as SVG | <img src="images/book-of-shapes.webp" width="400" alt="Flowing lines bending around four vortex points"> |
| [GeoPatternLab](https://geopatternlab.com/) — over 50 browser tools for kaleidoscopes, mandalas, op art, tilings and Islamic geometry, the vector ones export SVG and every setting sits in the URL | <img src="images/geopatternlab.webp" width="400" alt="Interlocking star and polygon pattern in gold lines"> |
| [Morphing Tilings](https://morphingtiling.wordpress.com/2010/12/24/hello-world/) — free TrueType fonts where each uppercase letter is a Truchet or morphing tile, type a block of text and convert the outlines to paths |  |
...
| | |
|---|:---:|
| [city-roads](https://anvaka.github.io/city-roads/) — draws every road of a city from OpenStreetMap and exports SVG, [source](https://github.com/anvaka/city-roads) | <img src="images/city-roads-zurich.webp" width="400" alt="All roads of Zürich drawn as thin lines"> |
| [Peak map](https://anvaka.github.io/peak-map/) — ridgeline drawing of the elevation of any region, exports SVG | <img src="images/peak-map.webp" width="400" alt="Ridgeline drawing of a mountain range"> |
...
| [Pen Plotter Calibration](https://laserpilot.github.io/Pen-Plotter-Calibration/) — browser tool that builds per pen test sheets for spacing, hatching and stippling, plus an analyzer that flags and nudges apart lines in your SVG that sit too close |  |
